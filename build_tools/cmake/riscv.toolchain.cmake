...
elseif(RISCV_CPU STREQUAL "rv32-baremetal")
  ...
  set(IREE_HAL_DRIVERS_TO_BUILD "" CACHE STRING "" FORCE)
  ...
  set(IREE_BUILD_BAREMETAL ON CACHE BOOL "Builds IREE in bare-metal configuration" FORCE)
  list(APPEND RISCV_COMPILER_FLAGS "-march=rv32gc -mabi=ilp32 -DIREE_PLATFORM_GENERIC=1 -DIREE_SYNCHRONIZATION_DISABLE_UNSAFE=1")
